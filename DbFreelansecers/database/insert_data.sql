...
(3, 'Telegram-бот для поддержки клиентов',
    ...
    '2026-07-15 23:59:59'),
(2, 'Интеграция Telegram-бота с CRM',
    'Нужно подключить бота поддержки к CRM и настроить хранение истории обращений.',
    '2026-01-10 10:00:00', 'Python, PostgreSQL, REST API', 70000.00,
    '2026-02-20 23:59:59'),
(3, 'Редизайн личного кабинета',
    'Обновить UX личного кабинета и подготовить кликабельный прототип в Figma.',
    '2026-01-18 13:30:00', 'Figma, UI/UX, Web Design', 55000.00,
    '2026-02-28 23:59:59'),
(3, 'React-виджеты для образовательной платформы',
    'Сверстать интерактивные виджеты прогресса и расписания занятий.',
    '2026-02-05 09:15:00', 'React, TypeScript, CSS', 65000.00,
    '2026-03-20 23:59:59'),
(4, 'SEO-продвижение сайта строительной компании',
    'Подготовить семантическое ядро, настроить аналитику и базовую оптимизацию страниц.',
    '2026-02-12 11:45:00', 'SEO, аналитика, контент', 45000.00,
    '2026-03-25 23:59:59');


INSERT INTO order_responses (freelancer_id, order_id, title, status, response_date) VALUES
(1, 2, 'Готов разработать API с документацией Swagger', 'pending', '2026-05-02 09:30:00'),
...
(2, 3, 'Портфолио лендингов прилагаю в личном сообщении', 'pending', '2026-05-04 10:20:00'),
(10, 2, 'Дизайн + анимация интерфейса', 'pending', '2026-05-05 13:45:00'),
(6, 6, 'Сделаю блог на Laravel с админкой Filament', 'accepted', '2026-04-22 18:00:00'),
...
(4, 2, 'Верстаю React-компоненты любой сложности', 'accepted', '2026-04-27 09:15:00'),
(2, 4, 'Могу и дизайн подкорректировать при необходимости', 'rejected', '2026-04-28 16:40:00'),
(5, 1, 'Настрою рекламу с окупаемостью от 300%', 'accepted', '2026-03-02 08:00:00'),
(6, 4, 'Сделаю блог на Laravel с админкой Filament', 'accepted', '2026-02-16 11:30:00'),
(7, 7, 'Проведу технический аудит и подготовлю отчёт с рекомендациями', 'accepted', '2026-04-11 14:00:00'),
(1, 8, 'Соберу бота на Python и подключу PostgreSQL', 'accepted', '2026-05-08 10:30:00'),
(1, 9, 'Настрою интеграцию с CRM и API', 'accepted', '2026-01-11 12:00:00'),
(2, 10, 'Сделаю прототип и UI-kit в Figma', 'accepted', '2026-01-19 15:20:00'),
(4, 11, 'Сверстаю виджеты на React и TypeScript', 'accepted', '2026-02-06 10:10:00'),
(5, 12, 'Проведу аудит и настрою аналитику', 'accepted', '2026-02-13 09:40:00');
...
(2, 4, 'active', '2026-04-25 12:00:00', 60000.00, '2026-06-15 23:59:59', NULL, NULL),
(4, 6, 'active', '2026-04-30 10:00:00', 85000.00, '2026-06-30 23:59:59', NULL, NULL),
(1, 5, 'completed', '2026-03-05 09:00:00', 150000.00, '2026-07-01 23:59:59', 5, 5),
(6, 6, 'completed', '2026-02-20 15:00:00', 115000.00, '2026-04-15 23:59:59', 4, 5),
(7, 7, 'cancelled', '2026-04-12 11:00:00', 25000.00, '2026-05-10 23:59:59', NULL, NULL),
(8, 1, 'completed', '2026-05-09 10:00:00', 78000.00, '2026-07-15 23:59:59', 5, 4),
(9, 1, 'completed', '2026-01-12 10:00:00', 72000.00, '2026-02-20 23:59:59', 4, 5),
(10, 2, 'completed', '2026-01-20 11:00:00', 56000.00, '2026-02-28 23:59:59', 5, 5),
(11, 4, 'completed', '2026-02-07 09:30:00', 65000.00, '2026-03-20 23:59:59', 4, 5),
(12, 5, 'completed', '2026-02-14 10:30:00', 45000.00, '2026-03-25 23:59:59', 3, 4);

INSERT INTO transactions (contract_id, status, transaction_date, amount) VALUES
(1, 'completed', '2026-04-25 12:05:00', 30000.00), 
(1, 'pending',   '2026-06-01 00:00:00', 30000.00),  
(2, 'completed', '2026-04-30 10:10:00', 42500.00),  
(3, 'completed', '2026-03-05 09:10:00', 150000.00),
(4, 'completed', '2026-02-20 15:30:00', 57500.00),  
(4, 'completed', '2026-04-16 10:00:00', 57500.00),  
(5, 'refunded',  '2026-04-20 14:00:00', 25000.00),
(6, 'completed', '2026-05-09 10:15:00', 78000.00),
(7, 'completed', '2026-02-20 16:00:00', 72000.00),
(8, 'completed', '2026-02-28 12:00:00', 56000.00),
(9, 'completed', '2026-03-20 13:30:00', 65000.00),
(10, 'completed', '2026-03-25 17:45:00', 45000.00);
